...
const renderOrden = async ()=>{
    ...
    cart.forEach(producto =>{
        ...
        liProducto.innerHTML = `<strong class="small font-weight-bold">(${producto.quantity})-${producto.product.nombre}</strong><span class="text-muted small">$${producto.product.precio*producto.quantity}</span>`;
